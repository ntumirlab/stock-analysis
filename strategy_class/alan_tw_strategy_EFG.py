"""
Alan TW Strategy EFG (Combined)
策略 EFG: 組合 E、F、G 三個策略條件

此策略為三個子策略的組合 (E|F|G)：
- 策略 E: top_n=40, 營益率 12%, BIAS: 3~13, 5~16, 8~19, 8~20, 5~35, 8~35, 創480天新高
...
class AlanTWStrategyEFG(AlanTWStrategyBase):
    """
    Alan TW Strategy EFG - 策略 E|F|G 組合
    """
