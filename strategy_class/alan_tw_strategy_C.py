...
class AlanTWStrategyC:
    ...
    def _build_chip_buy_condition(self):
        ...
        investment_trust_top_2d_ratio = (
            investment_trust_net_buy_ratio_2d_sum.rank(axis=1, ascending=False) <= self.top_n
        )
        investment_trust_top_3d_ratio = (
            investment_trust_net_buy_ratio_3d_sum.rank(axis=1, ascending=False) <= self.top_n
        )
