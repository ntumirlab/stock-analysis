"""
Alan TW Strategy EFG Observe DI21 Bias05
基底同 AlanTWStrategyEFGObserve，出場條件改為：

    3日線↓ AND DIF↓ AND (-DI>21 OR (3日乖離<-0.5% AND 5日乖離<-0.5%))
"""
...
class AlanTWStrategyEFGObserveDI21Bias05(AlanTWStrategyEFGObserve):
    """
    EFG Observe 策略，搭配新出場條件：
    3日線↓ AND DIF↓ AND (-DI>21 OR (3日乖離<-0.5% AND 5日乖離<-0.5%))
    """

    def get_strategy_name(self):
        return "EFG_Observe_新出場_乖離0.5%_DI21"
...
if __name__ == "__main__":
    ...
    strategy = AlanTWStrategyEFGObserveDI21Bias05()
