...
class OscarAndOrStrategy:
    ...
    def __init__(
        ...
        # Pure AND/OR strategy: composite scoring is intentionally disabled.
        self.use_composite_scoring = False
    ...
    def load_market_data():
        ...
        Returns:
            dict: 包含所有必要數據的字典
        """
        if OscarAndOrStrategy._MARKET_DATA_CACHE is not None:
            return OscarAndOrStrategy._MARKET_DATA_CACHE
        ...
        OscarAndOrStrategy._MARKET_DATA_CACHE = loaded
        return loaded
